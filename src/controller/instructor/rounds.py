...
class Rounds(webapp2.RequestHandler):
    def get(self):
        ...
        # And get all the courses and assignments for this instructor
    ...
    def post(self):
        ...
        if not action:
            ...
            if action == 'add':
                ...
                # Grab assignment object and instructor email to pass to email function
                email_course, email_assignment = utils.get_course_and_assignment_objs(self.request, instructor)
